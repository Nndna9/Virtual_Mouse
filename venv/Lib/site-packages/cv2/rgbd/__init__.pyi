...
class OdometryFrame(RgbdFrame):
    @property
    def pyramidImage(self) -> typing.Sequence[cv2.typing.MatLike]: ...
    @property
    def pyramidDepth(self) -> typing.Sequence[cv2.typing.MatLike]: ...
    @property
    def pyramidMask(self) -> typing.Sequence[cv2.typing.MatLike]: ...
    @property
    def pyramidCloud(self) -> typing.Sequence[cv2.typing.MatLike]: ...
    @property
    def pyramid_dI_dx(self) -> typing.Sequence[cv2.typing.MatLike]: ...
    @property
    def pyramid_dI_dy(self) -> typing.Sequence[cv2.typing.MatLike]: ...
    @property
    def pyramidTexturedMask(self) -> typing.Sequence[cv2.typing.MatLike]: ...
    @property
    def pyramidNormals(self) -> typing.Sequence[cv2.typing.MatLike]: ...
    @property
    def pyramidNormalsMask(self) -> typing.Sequence[cv2.typing.MatLike]: ...
...
class RgbdOdometry(Odometry):
    # Functions
    @classmethod
    def create(cls, cameraMatrix: cv2.typing.MatLike | None = ..., minDepth: float = ..., maxDepth: float = ..., maxDepthDiff: float = ..., iterCounts: typing.Sequence[int] = ..., minGradientMagnitudes: typing.Sequence[float] = ..., maxPointsPart: float = ..., transformType: int = ...) -> RgbdOdometry: ...
...
class ICPOdometry(Odometry):
    # Functions
    @classmethod
    def create(cls, cameraMatrix: cv2.typing.MatLike | None = ..., minDepth: float = ..., maxDepth: float = ..., maxDepthDiff: float = ..., maxPointsPart: float = ..., iterCounts: typing.Sequence[int] = ..., transformType: int = ...) -> ICPOdometry: ...
...
class RgbdICPOdometry(Odometry):
    # Functions
    @classmethod
    def create(cls, cameraMatrix: cv2.typing.MatLike | None = ..., minDepth: float = ..., maxDepth: float = ..., maxDepthDiff: float = ..., maxPointsPart: float = ..., iterCounts: typing.Sequence[int] = ..., minGradientMagnitudes: typing.Sequence[float] = ..., transformType: int = ...) -> RgbdICPOdometry: ...
...
class FastICPOdometry(Odometry):
    # Functions
    @classmethod
    def create(cls, cameraMatrix: cv2.typing.MatLike, maxDistDiff: float = ..., angleThreshold: float = ..., sigmaDepth: float = ..., sigmaSpatial: float = ..., kernelSize: int = ..., iterCounts: typing.Sequence[int] = ...) -> FastICPOdometry: ...
