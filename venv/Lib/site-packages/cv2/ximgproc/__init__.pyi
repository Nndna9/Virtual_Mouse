...
class EdgeDrawing(cv2.Algorithm):
    ...
    def getSegments(self) -> typing.Sequence[typing.Sequence[cv2.typing.Point]]: ...

    def getSegmentIndicesOfLines(self) -> typing.Sequence[int]: ...
...
class EdgeBoxes(cv2.Algorithm):
    # Functions
    @typing.overload
    def getBoundingBoxes(self, edge_map: cv2.typing.MatLike, orientation_map: cv2.typing.MatLike, scores: cv2.typing.MatLike | None = ...) -> tuple[typing.Sequence[cv2.typing.Rect], cv2.typing.MatLike]: ...
    @typing.overload
    def getBoundingBoxes(self, edge_map: cv2.UMat, orientation_map: cv2.UMat, scores: cv2.UMat | None = ...) -> tuple[typing.Sequence[cv2.typing.Rect], cv2.UMat]: ...
