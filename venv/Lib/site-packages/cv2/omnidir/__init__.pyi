...
# Functions
@typing.overload
def calibrate(objectPoints: typing.Sequence[cv2.typing.MatLike], imagePoints: typing.Sequence[cv2.typing.MatLike], size: cv2.typing.Size, K: cv2.typing.MatLike, xi: cv2.typing.MatLike, D: cv2.typing.MatLike, flags: int, criteria: cv2.typing.TermCriteria, rvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., tvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., idx: cv2.typing.MatLike | None = ...) -> tuple[float, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], cv2.typing.MatLike]: ...
@typing.overload
def calibrate(objectPoints: typing.Sequence[cv2.UMat], imagePoints: typing.Sequence[cv2.UMat], size: cv2.typing.Size, K: cv2.UMat, xi: cv2.UMat, D: cv2.UMat, flags: int, criteria: cv2.typing.TermCriteria, rvecs: typing.Sequence[cv2.UMat] | None = ..., tvecs: typing.Sequence[cv2.UMat] | None = ..., idx: cv2.UMat | None = ...) -> tuple[float, cv2.UMat, cv2.UMat, cv2.UMat, typing.Sequence[cv2.UMat], typing.Sequence[cv2.UMat], cv2.UMat]: ...
...
@typing.overload
def stereoCalibrate(objectPoints: typing.Sequence[cv2.typing.MatLike], imagePoints1: typing.Sequence[cv2.typing.MatLike], imagePoints2: typing.Sequence[cv2.typing.MatLike], imageSize1: cv2.typing.Size, imageSize2: cv2.typing.Size, K1: cv2.typing.MatLike, xi1: cv2.typing.MatLike, D1: cv2.typing.MatLike, K2: cv2.typing.MatLike, xi2: cv2.typing.MatLike, D2: cv2.typing.MatLike, flags: int, criteria: cv2.typing.TermCriteria, rvec: cv2.typing.MatLike | None = ..., tvec: cv2.typing.MatLike | None = ..., rvecsL: typing.Sequence[cv2.typing.MatLike] | None = ..., tvecsL: typing.Sequence[cv2.typing.MatLike] | None = ..., idx: cv2.typing.MatLike | None = ...) -> tuple[float, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], cv2.typing.MatLike]: ...
@typing.overload
def stereoCalibrate(objectPoints: typing.Sequence[cv2.UMat], imagePoints1: typing.Sequence[cv2.UMat], imagePoints2: typing.Sequence[cv2.UMat], imageSize1: cv2.typing.Size, imageSize2: cv2.typing.Size, K1: cv2.UMat, xi1: cv2.UMat, D1: cv2.UMat, K2: cv2.UMat, xi2: cv2.UMat, D2: cv2.UMat, flags: int, criteria: cv2.typing.TermCriteria, rvec: cv2.UMat | None = ..., tvec: cv2.UMat | None = ..., rvecsL: typing.Sequence[cv2.UMat] | None = ..., tvecsL: typing.Sequence[cv2.UMat] | None = ..., idx: cv2.UMat | None = ...) -> tuple[float, typing.Sequence[cv2.UMat], typing.Sequence[cv2.UMat], typing.Sequence[cv2.UMat], cv2.UMat, cv2.UMat, cv2.UMat, cv2.UMat, cv2.UMat, cv2.UMat, cv2.UMat, cv2.UMat, typing.Sequence[cv2.UMat], typing.Sequence[cv2.UMat], cv2.UMat]: ...
